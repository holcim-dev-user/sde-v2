...
export default ({
    ...
    mounted(){//NO debe ser created, porque aun NO estaría creado el componente editForm
        let newEditConfig = {
            spSelectName: 'spCamionesSelectEdit',
            spUpdateName: 'spCamionesUpdate',
            toolbarTitle: "Camiones",
            toolbarTitleName: "basic.name_es",
            startTab: 'basic',
            moduleTabs: [
                { tabName: 'basic', iconName: 'fas fa-info-circle', textLabel: 'Información de Camión', isTabDisable: false, rootPath:'pages', importPath: 'RootMaster/Camiones/CamionesEditBasic.vue' },
