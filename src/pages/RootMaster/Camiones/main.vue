...
export default ({
    ...
    data () {
        return {
            moduleName: "Camiones", //this should match the module Name (same as table sys_links.link_name) AND should match Vuex Store Name
            moduleMainRoute: '/RootMaster/Camiones',
            rptName_: 'Datos de Camiones', rptLink_: 'sysUser', rptLinkCompany_: true, rptType_: 'ssrs',
        }
    },
    computed:{
        mainRoute: {
