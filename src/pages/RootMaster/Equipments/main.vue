...
export default ({
    ...
    data () {
        return {
            moduleName: "Equipments", //this should match the module Name (same as table sys_links.link_name) AND should match Vuex Store Name
            moduleMainRoute: '/RootMaster/Equipments',
            rptName_: 'Datos de Dispositivos', rptLink_: 'sysUser', rptLinkCompany_: true, rptType_: 'ssrs',
        }
    },
    computed:{
        mainRoute: {
