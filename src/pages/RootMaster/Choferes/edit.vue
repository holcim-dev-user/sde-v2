...
export default ({
    ...
    mounted(){//NO debe ser created, porque aun NO estaría creado el componente editForm
        let newEditConfig = {
            ...
            toolbarTitleName: "basic.nom?chofer",
            startTab: 'basic',
            moduleTabs: [
                { tabName: 'basic', iconName: 'fas fa-info-circle', textLabel: 'Información de Chofer', isTabDisable: false, rootPath:'pages', importPath: 'RootMaster/Chofer/ChoferEditBasic.vue' },
