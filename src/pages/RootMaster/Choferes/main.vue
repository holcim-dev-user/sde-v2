...
export default ({
    ...
    data () {
        return {
            moduleName: "Choferes", //this should match the module Name (same as table sys_links.link_name) AND should match Vuex Store Name
            moduleMainRoute: '/RootMaster/Choferes',
            rptName_: 'Datos de Choferes', rptLink_: 'sysUser', rptLinkCompany_: true, rptType_: 'ssrs',
        }
    },
    computed:{
        mainRoute: {
