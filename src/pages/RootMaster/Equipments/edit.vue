...
export default ({
    ...
    mounted(){//NO debe ser created, porque aun NO estaría creado el componente editForm
        let newEditConfig = {
            spSelectName: 'spEquipmentsSelectEdit',
            spUpdateName: 'spEquipmentsUpdate',
            toolbarTitle: "Dispositivo",
            toolbarTitleName: "basic.equipmentNumber",
            startTab: 'basic',
            moduleTabs: [
                { tabName: 'basic', iconName: 'fas fa-info-circle', textLabel: 'Información de Dispositivo', isTabDisable: false, rootPath:'pages', importPath: 'RootMaster/Equipments/EquipmentsEditBasic.vue' },
