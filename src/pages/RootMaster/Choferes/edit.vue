...
export default ({
    ...
    mounted(){//NO debe ser created, porque aun NO estaría creado el componente editForm
        let newEditConfig = {
            spSelectName: 'spChoferesSelectEdit',
            spUpdateName: 'spChoferesUpdate',
            toolbarTitle: "Choferes",
            toolbarTitleName: "basic.nom_chofer",
            startTab: 'basic',
            moduleTabs: [
                { tabName: 'basic', iconName: 'fas fa-info-circle', textLabel: 'Información de Chofer', isTabDisable: false, rootPath:'pages', importPath: 'RootMaster/Choferes/ChoferesEditBasic.vue' },
